...
The results which shown in the table \ref{tab:all_results} and table \ref{tab:f1_results} are the results of adopting grid search.
...
The detailed results of the experiment will be published in the wandb website \footnote{Due to it is anonymous, it can not be shown now.}.
