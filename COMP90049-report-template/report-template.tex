...
The results of all models that are mentioned in this report are shown in the table \ref{tab:all_results}.


\begin{table*}
    \begin{center}
        \captionof{table}{Accuracy Comparison} \label{tab:all_results}
        ...
        \bottomrule
        \end{tabularx}
        \bigskip The best accuracy is marked with $^*$.
    \end{center}
\end{table*}
